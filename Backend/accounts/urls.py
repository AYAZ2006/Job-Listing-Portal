...
from .views import CandidateSignupView, RecruiterSignupView,CandidateLoginView,RecruiterLoginView,JobViewSet,InternshipViewSet,MyInternshipsView,MyJobsView,CandidateNotificationsView,ToggleFavoriteView,FavoriteListView,ApplyJobView,AppliedJobsView,ContactView,ResumeUploadView,ResumeListView,ResumeDeleteView,ResumeDownloadView,ResumeUpdateView,CandidateProfileView,ChangePasswordView,DeleteAccountView,JobApplicantsView,UpdateStatusView,AppliedInternshipsView,ApplyInternshipView,InternshipApplicantsView,EvaluatedCountView
...
urlpatterns = [
    path("candidate/signup/", CandidateSignupView.as_view()),
