...
function Post() {
  ...
  const handleJobSubmit = async (e) => {
    ...
    setLoading(true);
    try {
        const response = await axios.post("https://job-listing-portal-8.onrender.com/jobs/",formData,{headers: { "Content-Type": "multipart/form-data" },});
    ...
    const handleInternshipSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await axios.post("https://job-listing-portal-8.onrender.com/internships/",formData,{headers: { "Content-Type": "multipart/form-data" },});
