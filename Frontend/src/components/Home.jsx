...
function Home() {
  ...
  useEffect(() => {
    ...
    const loadApplied = async () => {
      try {
        const jobIdsRes = await axios.post("https://job-listing-portal-8.onrender.com/applied-jobs/", { email });
        const allJobs = await axios.get("https://job-listing-portal-8.onrender.com/jobs/");
        ...
        const internIdsRes = await axios.post("https://job-listing-portal-8.onrender.com/applied-internships/", { email });
        const allInternships = await axios.get("https://job-listing-portal-8.onrender.com/internships/");
  ...
  useEffect(() => {
    ...
    const fetchSavedJobs = async () => {
      try {
        const resFavorites = await axios.post("https://job-listing-portal-8.onrender.com/favorite-list/", { email });
        const favoriteItems = resFavorites.data.favorite_items || [];
        const jobsRes = await axios.get("https://job-listing-portal-8.onrender.com/jobs/");
        const internsRes = await axios.get("https://job-listing-portal-8.onrender.com/internships/");
