          ...
          <div className="p-10 flex flex-col justify-center space-y-6">
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSignup}>
              <div className="flex flex-col">
                ...
                <input type="email" placeholder="Enter your email" className="w-full px-4 py-3 rounded-lg bg-white/10 border border-gray-600 text-white" required value={email} onChange={(e) => setEmail(e.target.value)}/>
              </div>
              <div className="flex gap-4">
                <div className="flex-1 flex flex-col">
                  <label className="text-gray-300 text-sm mb-1">User Name *</label>
                  <input type="text" placeholder="First Name" className="w-full px-4 py-3 rounded-lg bg-white/10 border border-gray-600 text-white" required value={fname} onChange={(e) => setFname(e.target.value)}/>
                </div>
              ...
              <div className="flex flex-col">
                ...
                <div className="flex">
                  ...
                  <input type="tel" placeholder="Enter mobile number" className="flex-1 px-4 py-3 rounded-r-lg bg-white/10 border border-gray-600 text-white" required value={mobile} onChange={(e) => setMobile(e.target.value)}/>
                </div>
              </div>
