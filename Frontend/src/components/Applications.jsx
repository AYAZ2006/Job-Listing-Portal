...
export default function Applications() {
  ...
  const fetchAppliedJobs = async () => {
    try {
      const res = await axios.post("https://job-listing-portal-8.onrender.com/applied-jobs/", { email });
      const appliedData = res.data.applied_jobs || [];
      const jobsResponse = await axios.get("https://job-listing-portal-8.onrender.com/jobs/");
  ...
  const fetchAppliedInternships = async () => {
    try {
      const res = await axios.post("https://job-listing-portal-8.onrender.com/applied-internships/", { email });
      const appliedData = res.data.applied_internships || [];
      const all = await axios.get("https://job-listing-portal-8.onrender.com/internships/");
