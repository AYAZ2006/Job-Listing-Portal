...
export default function Recruiter() {
  ...
  const handleSignup = async(e) => {
    ...
    setLoading(true);  
    try {
      const res = await axios.post("https://jobchahiye.vercel.app/recruiter/send-otp/", { email });
  ...
  const handleResend = async () => {
    try {
      await axios.post("https://jobchahiye.vercel.app/recruiter/send-otp/", { email });
  ...
  const handleVerify = async (email, otp) => {
    setLoading(true);
    try {
      const res = await axios.post("https://jobchahiye.vercel.app/recruiter/verify-otp/", {email,otp,username: fname,password: password,mobile_number: mobile,organization_name: selectedCompany});
