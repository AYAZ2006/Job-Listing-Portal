...
export default function InternshipDetail() {
  ...
  useEffect(() => {axios.get(`https://jobchahiye.vercel.app/internships/${id}/`)
      .then((res) => setInternship(res.data))
      .catch((err) => console.error(err));
  }, [id]);
  useEffect(() => {axios.post("https://jobchahiye.vercel.app/apply-internship/", {internship_id: Number(id),email: localStorage.getItem("user_email"),check_only: true,})
  ...
  const applyJob = () => {
    setLoading(true);
    axios.post("https://jobchahiye.vercel.app/apply-internship/", {internship_id: Number(id),email: localStorage.getItem("user_email"),})
      .then(() => {
  ...
  const withdrawJob = () => {
    setLoading(true);
    axios.delete("https://jobchahiye.vercel.app/apply-internship/", {data: {internship_id: Number(id),email: localStorage.getItem("user_email"),},})
      .then(() => {
